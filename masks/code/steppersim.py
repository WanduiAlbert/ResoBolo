...
def run_sim(fn_spreadsheet, mask_cells):
    ...
    layer_cells = {}
    #layer_nums = {}
    layer_nums = {"Al_TES":1, "Outline":2, "PRO1":3, "Ti_TES":4, "GP":5,\
        "PRO2":6, "ILD_Via":7, "RES":8, "MS":9, "RES_pro":10, "heat_cap":11,\
        "pic_frame":12, "nitride":13, "XeF2_STS":14, "New Layer":15, "Lens":20,\
        "Die cutout":22, "Anodization":30}
    while True:
    ...
    cwafer = gdspy.Cell('Global_Overlay_Sim')
