...
Pbgs = [0.01, 0.1, 0.5, 0.9, 1.5, 5]
plt.figure(figsize=(10,10))
for Pbg in Pbgs:
	T = (Pbg/K + Tb**(n+1))**(1./(n + 1)) # island temperature
	q = (h*nu/2/k/T)
	...
	plt.semilogy(Tb/mK, dQi, label="Background power:%1.1fpW"%(Pbg))
...
plt.savefig("dQi_vs_T_with_bgpower.png")
plt.show()
exit()
#print ("\n\n%1.3f\n%1.3e"%(T, x))
#print ("%1.3f\n%1.3e\n\n\n\n"%(kappa, G))
